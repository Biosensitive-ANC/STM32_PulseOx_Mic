...
int main(void)
{
	...
	/*
  CDC_Transmit_FS(message, strlen((char*)message));  //USB virtual serial port output debugging information
 				HAL_UART_Transmit(&huart2, message, sizeof(message) - 1, 100);  //UART2 serial port output debugging information
